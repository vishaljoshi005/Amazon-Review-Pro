...
import {RegisterService} from '@/core/services/miscellaneous-noAuth/register.service';
...
export class RegisterComponent implements OnInit {
  ...
  constructor( private formBuilder: FormBuilder, private router: Router,
               private registerService: RegisterService, private userValidator: UserValidatorsService) { }
